...
describe('Registration page', () => {
  it('Should register appropriately', () => {
    ...
    cy.findByTestId('updates-modal-confirm')
      .scrollIntoView()
      .should('exist')
      .and('be.visible')
      .click();
    ...
    cy.findByTestId('registration-password-confirmation')
      ...
      .focused()
      .type('not-matching');
    cy.findByTestId('registration-button').should('exist').and('be.visible').click();

    cy.findByTestId('registration-error')
      .should('exist')
      .and('be.visible')
      .and('contain.text', "Password doesn't match");
    cy.findByTestId('registration-password-confirmation')
      .click()
      .focused()
      .clear()
      .type('password1');
    cy.findByTestId('registration-button').click();

    cy.findByTestId('codename-registration-title').should('exist').and('be.visible');
    ...
    cy.findByTestId('codename-registration-options')
      ...
      .first()
      .invoke('text')
      .then((newVal) => expect(newVal).to.not.equal(firstElementText));
    ...
    cy.window()
      .its('performance')
      .invoke('measure', 'registration')
      .its('duration')
      .then((duration) => cy.log(`Registration took ${Math.floor(duration / 1000)} seconds`));
    ...
    cy.findByTestId('channel-name-input')
      .should('exist')
      .and('be.visible')
      .click()
      .focused()
      .type('NewChannel');
    cy.findByTestId('channel-description-input')
      .should('exist')
      .and('be.visible')
      .click()
      .focused()
      .type('Channel description here');
    ...
    cy.findByTestId('channel-privacy-level-badge')
      .should('exist')
      .and('be.visible')
      .should('contain.text', 'Public');
    cy.findByTestId('channel-admin-badge')
      .should('exist')
      .and('be.visible')
