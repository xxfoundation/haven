...
const createCustomButton = ( func: 'toggleBlockType' | 'toggleInlineStyle', key: string, svg: React.ReactNode): FC<CustomEditorButton> => ({ editorState, onChange }) => {
...
const deflateContent = (content: string) => zlib.deflateSync(content).toString('base64');
