...
const Button: FC<Props> = ({
  ...
  return (
    <Component
      ...
      className={cn(
        {
          'px-6 py-2 disabled:hover:cursor-not-allowed font-bold text-md rounded-3xl': variant !== 'unstyled',
        ...
        variant !== 'unstyled' && {
          'h-7 text-xs py-1 px-2.5': size === 'sm',
          'h-10 min-w-[9.5rem]': size === 'md',
          'h-14 min-w-[9.5rem]': size === 'lg'
        },
        rest.className
      )}
    >
