...
const CreateChannelView: FC = () => {
  ...
  const onCreate = useCallback(async () => {
    if (!regex.test(channelName)) {
      setError(t('The name must be between 3 and 24 characters inclusive. It can only include upper and lowercase Unicode letters, digits 0 through 9, and underscores (_).'));
      return;
    }
    try {
  ...
  return (
    <>
      ...
      <div className='space-y-4 w-full'>
        ...
        />
        <textarea
          className='focus-visible:outline-none resize-none h-10 active:outline-0 w-full rounded-2xl bg-charcoal-4 border border-charcoal-1 px-4 py-2 placeholder-charcoal-1 placeholder:text-sm focus:h-24 transition-all'
      ...
      <div className='flex justify-center mt-8 w-full items-center'>
        <div className='rounded-full bg-charcoal-3 flex h-10 relative'>
          <div className={cn(
            'absolute h-10 rounded-full bg-primary w-28 transition-all',
            {
