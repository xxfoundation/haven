...
const ShareChannelView: FC = () => {
  ...
  return (
    <>
      <ModalTitle className='mb-0'>{t('Share Space')}</ModalTitle>
      ...
      <div className='w-full'>
        ...
        <span className='text-charcoal-1 py-2 block max-w-[100%] overflow-hidden overflow-x-auto'>
          {currentChannel?.id || ''}
        </span>
      </div>
      ...
      {credentials.url.length > 0 && (
        <div className='w-full'>
          <h6 className='uppercase'>{t('Invite link')}</h6>
          <div className='flex items-center text-charcoal-1'>
            <span
              className={cn(
                'py-2 whitespace-nowrap block max-w-[100%] overflow-hidden overflow-x-auto transition-all duration-100',
                {
      ...
      {credentials.password.length > 0 && (
        <div className='w-full'>
          <h6 className='uppercase'>{t('Password')}</h6>
          <div className='flex items-center text-charcoal-1'>
            <span
              className={cn(
                'py-2 whitespace-nowrap block max-w-[100%] overflow-hidden overflow-x-auto transition-all duration-100',
      ...
      <p className={cn('text-orange text--xs tracking-wide')}>
