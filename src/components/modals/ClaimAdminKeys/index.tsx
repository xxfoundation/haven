...
const ExportCodenameView: FC = () => {
  ...
  const onImport = useCallback<React.FormEventHandler<HTMLFormElement>>(
    (evt) => {
      evt.preventDefault();
      try {
        ...
        setError(
          t(
            'That didnt work. Please check your credentials and make sure you are trying to import the correct channel.'
          )
        );
      }
    },
  ...
  return (
    <>
      <ModalTitle className='text-center text-2xl'>{t('Import Channel Admin Keys')}</ModalTitle>
      ...
      >
        <div className='flex items-center justify-center w-full'>
          <label
            ...
            className='flex flex-col items-center justify-center w-full h-32 border-2 border-charcoal-1 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800  hover:bg-charcoal-3-20'
          >
