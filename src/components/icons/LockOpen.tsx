...
const LockOpen = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <g>
        <path
          d='M285.8,329.2c0,11.2-6.5,20.5-14.9,25.2v64.3h-29.8v-64.3c-8.4-5.6-14.9-14-14.9-25.2
          ...
          c0-8.4-6.5-14.9-14.9-14.9H105.9c-8.4,0-14.9,6.5-14.9,14.9v212.6c0,8.4,6.5,14.9,14.9,14.9h300.3c8.4,0,14.9-6.5,14.9-14.9V254.6z'
          fill='currentColor'
        />
      </g>
    </svg>
