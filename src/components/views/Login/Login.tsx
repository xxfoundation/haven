          ...
          <div className="col-span-9 flex flex-col items-start">
            <Trans>
              ...
              <span className="text-[18px] mt-[18px]">
                ...
                <span className="bg-cyan p-2 ml-3 font-bold text-[18px]">Talk about what you want.</span>
              </span>
            </Trans>
            <Trans>
              <span className="text-[18px] mt-[18px]">
                Surveillance free. Censorship proof.
                <span className="bg-cyan p-2 ml-3 font-bold text-[18px]">Your Haven chats are yours.</span>
              </span>
            </Trans>
          </div>
