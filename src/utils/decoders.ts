...
export const channelDecoder = makeDecoder(
  JsonDecoder.object<ChannelJSON>(
    {
...
export const identityDecoder = makeDecoder(
  JsonDecoder.object<IdentityJSON>(
    {
...
export const shareUrlDecoder = makeDecoder(
  JsonDecoder.object<ShareURLJSON>(
    {
...
export const messageReceivedEventDecoder = makeDecoder(
  JsonDecoder.object<MessageReceivedEvent>(
    {
...
export const userMutedEventDecoder = makeDecoder(
  JsonDecoder.object<UserMutedEvent>(
    {
      channelId: JsonDecoder.string,
      pubkey: JsonDecoder.string,
...
export const nicknameUpdatedEventDecoder = makeDecoder(
  JsonDecoder.object<NicknameUpdatedEvent>(
    {
      channelId: JsonDecoder.string,
  ...
  JsonDecoder.object<NotificationUpdateEvent>(
    {
      ...
      deletedNotificationStates: JsonDecoder.nullable(
        JsonDecoder.array<ChannelId>(JsonDecoder.string, 'DeletedNotificationStatesDecoder')
      )
    },
...
export const adminKeysUpdateDecoder = makeDecoder(
  JsonDecoder.object<AdminKeysUpdateEvent>(
    {
      channelId: JsonDecoder.string
    },
...
export const channelDMTokenUpdateDecoder = makeDecoder(
  JsonDecoder.object<ChannelDMTokenUpdate>(
    {
      channelId: JsonDecoder.string,
...
export const channelStatusDecoder = JsonDecoder.enumeration<ChannelStatus>(
  ChannelStatus,
  'ChannelStatusDecoder'
);
...
export const dmNotificationLevelDecoder = JsonDecoder.enumeration<DMNotificationLevel>(
  DMNotificationLevel,
  'DMNotificationLevel'
);
...
const dmDeletedNotificationStatesDecoder = JsonDecoder.array<string>(
  JsonDecoder.string,
  'DmDeletedNotificationStateArray'
);

export const dmNotificationsUpdateEventDecoder = makeDecoder(
  JsonDecoder.object<DMNotificationsUpdateEvent>(
    {
...
export const blockedUserEventDecoder = makeDecoder(
  JsonDecoder.object<DMBlockedUserEvent>(
    {
      pubkey: JsonDecoder.string,
...
export const dmReceivedEventDecoder = makeDecoder(
  JsonDecoder.object<DMReceivedEvent>(
    {
      uuid: JsonDecoder.number,
      pubkey: JsonDecoder.string,
      update: JsonDecoder.boolean,
